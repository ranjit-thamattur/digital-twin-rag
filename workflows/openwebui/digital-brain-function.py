...
class Filter:
    ...
    def pipe(
        ...
        # 2. Call MCP Bridge (using the new OpenAI-compatible endpoint)
        try:
            headers = {
                "Authorization": "Bearer mcp-bridge",
            ...
            payload = {
                "model": "digital-brain",
                "messages": messages,
                "user": __user__ # Pass the full user object for automatic tenant extraction
            }
